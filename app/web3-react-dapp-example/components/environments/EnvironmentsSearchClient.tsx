...
export default function EnvironmentsSearchClient({ items }: { items: Environment[] }) {
  ...
  const filtered = useMemo(() => {
    ...
    return items.filter((e) => [e.name, e.description, e.owner, e.slug, ...e.tags].some((s) => s.toLowerCase().includes(q)));
  }, [items, query]);
